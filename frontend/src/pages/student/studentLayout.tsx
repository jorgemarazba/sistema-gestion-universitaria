...
const navItems: NavItem[] = [
  { label: 'Inscripción', path: '/student/inscripcion', icon: <BookOpen size={18} /> },
  { label: 'Pagos', path: '/student/pagos', icon: <CreditCard size={18} /> },
  { label: 'Calificaciones', path: '/student/calificaciones', icon: <Award size={18} /> },
  { label: 'Historial', path: '/student/historial', icon: <History size={18} /> },
  { label: 'Documentos', path: '/student/documentos', icon: <FileText size={18} /> },
  { label: 'Horario', path: '/student/horario', icon: <Clock size={18} /> },
  { label: 'Soporte', path: '/student/soporte', icon: <HelpCircle size={18} /> },
  { label: 'Mensajes', path: '/student/mensajes', icon: <MessageSquare size={18} /> },
  { label: 'Reportes', path: '/student/reportes', icon: <BarChart3 size={18} /> },
  { label: 'Perfil', path: '/student/perfil', icon: <User size={18} /> },
];
    ...
    <div className="flex flex-col h-screen font-sans" style={backgroundStyle}>
      <header className="h-16 bg-slate-900/95 border-b border-slate-700 flex items-center justify-between px-4 sticky top-0 z-50 shadow-lg backdrop-blur-sm">
        <div className="flex items-center gap-3">
          ...
          <span className="text-white font-bold text-xl hidden lg:block">Estudiante</span>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-white text-sm font-medium hidden lg:block">Estudiante</span>
          </div>
